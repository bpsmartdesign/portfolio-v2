  ...
  data() {
    return {
      works: [
        {
          name: 'myPortfolio',
          img: '/works/portfolio.webp',
          uri: 'https://bpsmartdesign.tk',
          github: 'https://github.com/bpsmartdesign/portfolio-v2',
          keyword: [
            '#software_engineer',
            '#portfolio',
            '#bpsmartdesign',
          ...
          tags: ['Nuxt Js', 'Vue Js', 'Javascript', 'Github', 'Netlify'],
          description: this.$t('entity.portfolio-full-desc'),
          shortDescription: this.$t('entity.portfolio-short-desc'),
        },
        {
          name: 'Workbud',
